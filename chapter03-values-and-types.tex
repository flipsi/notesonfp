...
data T a_1 a_2 ... a_n = K_1 b_11 ... b_1n_1
  ...
  \item \textbf{Sum Type} (n=0, n$_i$ = 0) 
        \codefile{haskell}{caption={weekday.hs}, label=weekday}{../material/weekday.hs}
  ...
  \end{tabular}\end{center}\vspace{9pt}
  \codefile{haskell}{caption={deriving.hs}, label=deriving}{../material/deriving.hs}
  \item \textbf{Product Types} (r=1)
  \codefile{haskell}{caption={sequence.hs}, label=sequence}{../material/sequence.hs}
  \item \textbf{Sum-of-Product-Types}\\
    ...
    \codefile{haskell}{caption={cons.hs}, label=cons}{../material/cons.hs}
  ...
  \codefile{haskell}{caption={eval-compile-run.hs}, label=eval-compile-run}{../material/eval-compile-run.hs}
